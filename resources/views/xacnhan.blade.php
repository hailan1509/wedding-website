...
<head>
	...
	<link rel="shortcut icon" type="image/x-icon" href="https://dinhanhhoangyen.iwedding.info//rsvp-template/favicon.ico">
...
<body>
    <main class="container my-3 my-md-5">
    	<div class="text-center">
    		<img style="max-width:350px;" class="w-100 border border-danger p-1 mb-5 border-2 rounded-circle" src="https://cdn.biihappy.com/ziiweb/website/6735a912bd76f0d27e090616/96bd34063222860361fff09bb2356664.jpeg" />
    	</div>
        <div>
	...
	<script src="https://dinhanhhoangyen.iwedding.info//rsvp-template/script.js?v=20211102"></script>
	<script>
		var webroot = 'https://dinhanhhoangyen.iwedding.info/';
