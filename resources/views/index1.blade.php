                     ...
                     <div class="row align-items-center">
                        ...
                        <div class="col-lg-2 col-md-6 col-6">
                           <div class="navbar-header">
                              <a href="/">
                                 <h1 style="font-size:25px">A<span class="main-color" ><i class="fa fa-heart" style="margin:5px 5px 5px 10px;" ></i></span>Y</h1>
                              </a>
                           </div>
                        </div>
            ...
            <div class="row button-accessibilities animate-box" data-animate-effect="fadeInUp">
               <div class="col col-12">
                  <div class="text-center">
                     <a href="https://dinhanhhoangyen.iwedding.info/rsvp" target="_blank" class="theme-btn album theme-btn-s3">
                        ...
                        <div class="wpo-event-item">
                           <div class="wpo-event-text">
                              ...
                              <ul>
                                 ...
                                 <li> <a  href="https://maps.app.goo.gl/Eiva86MKjZWWBZNU7" target="_blank">xem bản đồ </a></li>
                                 <li>
                                    <div class="calendar-button">
                                       <div class="atcb" style="display:none;">
                                          {
      ...
      <div id="menu-access" class="">
         ...
         <ul class="p-0 m-0 list-menu-icon">
            <li class="text-center">
               <a href="https://dinhanhhoangyen.iwedding.info/rsvp" target="_blank" class="text-white">
