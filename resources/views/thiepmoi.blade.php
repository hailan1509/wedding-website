...
<head>
    ...
    <meta property="og:image" content="{{ asset('assets/frontend/image/anh-cuoi/anh-doi-resize.JPG') }}" />
    <meta property="og:image:url" content="{{ asset('assets/frontend/image/anh-cuoi/anh-doi-resize.JPG') }}" />
    <meta property="og:image:secure_url" content="{{ asset('assets/frontend/image/anh-cuoi/anh-doi-resize.JPG') }}" />
