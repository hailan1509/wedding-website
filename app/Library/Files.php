...
class Files
{
    ...
    private static function uploadEachFile($file, $dir, $filename, $width = false, $height = false,$keepOrginExtention = false){
        $result = "";
    ...
    private static function uploadEachFile_extension($file, $dir, $filename, $width = false, $height = false,$keepOrginExtention = false){
        $result = "";
